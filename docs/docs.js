...
const visualOscillator = (svg) => {
  ...
  rectTop.setAttribute('height', lineWidth);
  rectTop.setAttribute('stroke', 'none');
  rectTop.setAttribute('fill', 'rgba(153 153 153 / 30%)');
  ...
  rectMiddle.setAttribute('height', lineWidth);
  ...
  rectBottom.setAttribute('height', lineWidth);
  rectBottom.setAttribute('stroke', 'none');
  rectBottom.setAttribute('fill', 'rgba(153 153 153 / 30%)');
...
const createEnvelope = (svg) => {
  ...
  path.setAttribute('stroke', 'rgba(0, 0, 255, 0.6)');
  path.setAttribute('fill', 'none');
  ...
  envelopePath.setAttribute('stroke', 'rgba(0, 0, 255, 1.0)');
  ...
  invertedEnvelopePath.setAttribute('stroke', 'rgba(0, 0, 255, 1.0)');
...
const createQuantization = (svg, bit, fillColor, showOriginal, showSampling) => {
  ...
  switch (bit) {
    case 3: {
      ['100', '101', '110', '111', '000', '001', '010', '011'].forEach((bit, index) => {
        ...
        rect.setAttribute('height', lineWidth);
        rect.setAttribute('stroke', 'none');
        rect.setAttribute('fill', 'rgb(255 0 255)');
        ...
        text.setAttribute('text-anchor', 'middle');
        text.setAttribute('stroke', 'none');
        text.setAttribute('fill', 'rgb(66 66 66)');
        text.setAttribute('font-size', '16px');
  ...
  if (showSampling) {
    for (let rad = 0; rad < 2 * Math.PI; rad += d) {
      ...
      path.setAttribute('d', `M${x} ${y} L${x} ${middle}`);
      path.setAttribute('stroke', 'rgba(0 0 255 / 60%)');
      path.setAttribute('fill', 'none');
      path.setAttribute('stroke-width', '4');
      path.setAttribute('stroke-linecap', 'square');
  ...
  switch (bit) {
    case 3: {
      for (let rad = 0, index = 0; rad < 2 * Math.PI; rad += d, index++) {
        ...
        path.setAttribute('d', `M${x} ${y} L${x} ${middle}`);
        path.setAttribute('stroke', 'rgba(255 0 255 / 60%)');
        path.setAttribute('fill', 'none');
        path.setAttribute('stroke-width', '4');
        path.setAttribute('stroke-linecap', 'square');
...
const createRotationFactors = (svg) => {
  ...
  circle.setAttribute('stroke', 'rgba(153 153 153 / 30%)');
  ...
  innerCircle.setAttribute('stroke', 'rgb(255 0 255)');
  ...
  arrow.setAttribute('fill', 'rgb(255 0 255)');
...
const visualSpectrum = (svgTime, svgSpectrum) => {
  ...
  rectTopSpectrum.setAttribute('height', lineWidth);
  rectTopSpectrum.setAttribute('stroke', 'none');
  rectTopSpectrum.setAttribute('fill', 'rgba(153 153 153 / 30%)');
  ...
  rectMiddleSpectrum.setAttribute('height', lineWidth);
  rectMiddleSpectrum.setAttribute('stroke', 'none');
  rectMiddleSpectrum.setAttribute('fill', 'rgba(153 153 153 / 30%)');
  ...
  pathTime.setAttribute('stroke', 'rgb(0 0 255)');
  ...
  pathSpectrum.setAttribute('stroke', 'rgb(0 0 255)');
