...
const animateUndulation = (svg) => {
  ...
  const buttonAnimationElement = document.getElementById('button-undulation-animation');
  const buttonElement = document.getElementById('button-undulation-half-pi');
...
animateFeedback(document.getElementById('svg-feedback-animation'));
createNodeConnectionsForDelay(document.getElementById('svg-node-connections-for-delay'));

createNodeConnectionsForReverb(document.getElementById('svg-node-connections-for-reverb'));

createRIR(document.getElementById('svg-impulse'));
animateRIR(document.getElementById('svg-impulse-response'));
renderRIR(document.getElementById('svg-rir'));

createConvolution(document.getElementById('svg-convolution'));
...
createNodeConnectionsForFlanger(document.getElementById('svg-node-connections-for-flanger'));

flanger();

animateFM(
  document.getElementById('svg-figure-frequency-modulation-time-animation'),
  document.getElementById('svg-figure-frequency-modulation-spectrum-animation')
);

createPhase(document.getElementById('svg-figure-phase'));
animatePhaseShift(document.getElementById('svg-figure-phase-shift-animation'));
animateUndulation(document.getElementById('svg-figure-undulation'));
