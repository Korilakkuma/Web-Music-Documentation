...
const alphaWaveColor = 'rgba(0 0 255 / 60%)';
const alphaLightWaveColor = 'rgba(255 0 255 / 60%)';
...
animateFM(document.getElementById('svg-frequency-modulation-time-animation'), document.getElementById('svg-frequency-modulation-spectrum-animation'));
